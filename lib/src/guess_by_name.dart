...
class GuessByName extends StatefulWidget {
  const GuessByName({super.key});

  @override
  State<GuessByName> createState() => _GuessByNameState();
}

class _GuessByNameState extends State<GuessByName> {
    ...
    return FutureBuilder(
      ...
      builder: ((context, snapshot){
        ...
        if (snapshot.hasData) {
          ...
          // var image = Image.network(pokemon.image!,color: Colors.black.withOpacity(0.5), scale: 0.9);
          // image.color = Colors.black.withOpacity(0.5);
  ...
  Future<List<Pokemon>> fetchPokemons() async {
    ...
    final response = await http
        .get(Uri.parse('https://pokeapi.co/api/v2/pokemon?limit=253&offset=152'));
